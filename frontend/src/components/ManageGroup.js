                ...
                >
                    ...
                    <DialogContent>
                        ...
                        <Box component="ul" sx={{ mt: 1, mb: 3, pl: 2 }}>
                            <Typography component="li" variant="body2">Remove all members from the group</Typography>
                            <Typography component="li" variant="body2">Delete all group data permanently</Typography>
                            <Typography component="li" variant="body2">Remove access to any shared content</Typography>
                        </Box>
